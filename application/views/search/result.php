...
<table id="table" class="display">
    ...
    ?>
        ...
        <tr>
           ...
           <td class="center"><a href="?delete=<?php echo $row['ids']; ?>" onclick="return(confirm('Etes-vous sûr de vouloir supprimer cette entrée?'));"><span class="glyphicon glyphicon-trash" aria-hidden="true" rel="tooltip" title="Supprimer <?php echo  $row['nom']; ?>"></span></a></td>
        </tr>
