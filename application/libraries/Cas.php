 ...
 *    return if user is admin */
    ...
    {
	if (phpCAS::isAuthenticated()) {
		if ($this->CI->Users->get_info()->rid == 1) {
			return true;
		}
		else {
			return false;
    ...
    public function is_groupe()
    {
	if (phpCAS::isAuthenticated() && $this->CI->Users->get_info()->id_groupe != 100) {
		return $this->CI->Users->get_info()->id_groupe;
	}
    }    
}
